package com.tory.nestedceiling.app.model

data class BannerData(val imageUrls: List<String> = listOf(
        "https://hellorfimg.zcool.cn/provider_image/large/2238406784.jpg",
